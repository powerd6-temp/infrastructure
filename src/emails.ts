...
export const mxEntries = new gandi.livedns.Record(
  "powerd6/rootDomain/nameServer/improvMX/MX",
  {
    name: "@",
    ttl: 10800,
    type: "MX",
...
export const spfRecord = new gandi.livedns.Record(
  "powerd6/rootDomain/nameServer/improvMX/TXT",
  {
    name: "@",
    ttl: 10800,
    type: "TXT",

...
export const roadmapProject = new github.OrganizationProject(
  "powerd6/Projects/roadmap",
  {
    name: "Roadmap",
...
export const ideasProject = new github.OrganizationProject(
  "powerd6/Projects/moduleIdeas",
  {
    name: "Module Ideas",
